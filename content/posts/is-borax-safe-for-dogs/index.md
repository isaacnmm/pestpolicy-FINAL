...
description: The first question is, is borax safe for dogs? The answer to this question
  is that it depends on the amount and how often they are exposed.
tags: 
  - fleas
  - borax
  - safe
---
The first question is, is [borax](/posts/is-borax-safe-for-cats/) [safe](/posts/pet-safe-roach-killer/) for dogs? The answer to this question is that it depends on the amount and how often they are exposed.
